                ...
                <div class="shadow p-2 rounded-2 mt-3">
                    ...
                    <div class="row p-lg-4 p-md-3 p-sm-2 p-1 mt-2 mt-md-2 mt-sm-2 mt-lg-0">
                        ...
                        <div class="col-lg-12 text-end mt-3">
                            <a type="button" href="<?php echo _WEB_ROOT; ?>/groups/ung-vien/chinh-sua?id=<?php echo $item['id']; ?>" class="btn border border-1 border-primary py-2 px-5 text-primary btn-save-info custom-btn-profile">Chỉnh
                                sửa</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row p-lg-4 p-md-3 p-sm-2 p-1 mt-2 mt-sm-2 mt-md-2 mt-lg-0">
                        <?php if (!empty($profileInformation)) : ?>
                            ...
                            <div class="col-lg-12 text-end mt-2">
                                <button type="submit" class="btn btn-primary border border-1 px-5 py-2 rounded-3 fw-semibold">Lưu và đăng hồ sơ</button>
                                <a class="btn btn-danger px-2 rounded-3 py-2" href="<?php echo _WEB_ROOT; ?>/jobs/ho-so-ung-vien">Quay lại</a>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
