                ...
                <ul class="m-0 p-0 ">
                    ...
                    ?>
                            <li class="border-1 rounded p-3 border-secondary border mb-3">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-6 p-0 mb-2">
                                        <?php
                                        switch ($item['status']):
                                            case 0:
                                                echo '<div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="' . _WEB_ROOT . '/ntd/quan-ly-ung-vien/ho-so-ung-tuyen/trang-thai?action=inactive&id=' . $item['id'] . '">Chờ duyệt</a></li>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-12">
                                        <p class="fs-6 fw-normal text-dark p-0 m-0 mb-1"><span class="fw-bold">Tên hồ sơ:</span> <a class="text-dark" href="<?php echo _WEB_ROOT; ?>/ntd/quan-ly-ung-vien/ho-so-ung-tuyen/xem-ho-so?id=<?php echo $item['candidate_id']; ?>"><?php echo $item['fullname']; ?></a></p>
