        ...
        <?php if (!empty($information)) : ?>
            <form method="post" class="m-auto custom-form-profile" enctype="multipart/form-data">
                ...
                <div class="sticky-bottom text-end ms-lg-auto mt-3 p-3" style="background-color: var(--section-color);">
                    <button type="submit" href="<?php echo _WEB_ROOT; ?>/quan-ly-tai-khoan/tai-khoan" style="background-color: var(--primary-color);" class="btn border border-1 px-5 py-2 rounded-3 text-white fw-semibold custom-btn-profile">Lưu và
                        đăng hồ sơ</button>
                </div>
            </form>
        <?php endif; ?>
