            ...
            <form method="post" class="m-auto custom-form-profile" enctype="multipart/form-data">
                ...
                <div class="shadow p-2 rounded-2">
                    ...
                    <div class="form-group mx-lg-4 mx-md-3 mx-sm-2 mx-1">
                        ...
                        <label for="upload-cv" class="text-primary border border-1 px-4 py-2 border-primary rounded-2 btn-upload-avatar custom-btn-profile text-center"><i class="bi bi-upload"></i> Tải file</label>
                ...
                <div class="shadow p-2 rounded-2 mt-3">
                    ...
                    <div class="row p-lg-4 p-md-3 p-sm-2 p-1 mt-2 mt-md-2 mt-sm-2 mt-lg-0">
                        ...
                        <div class="col-lg-12 text-end mt-3">
                            <a type="button" href="<?php echo _WEB_ROOT; ?>/quan-ly-tai-khoan/tai-khoan" class="btn border border-1 border-primary py-2 px-5 text-primary btn-save-info custom-btn-profile">Chỉnh
                                sửa</a>
                        </div>
                    </div>
                </div>
                        ...
                        <?php if (!empty($profileInformation)) : ?>
                            <div class="col-lg-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="job_desired" placeholder="E.g. Nhân viên kinh doanh" value="<?php echo $profileInformation['job_desired'] ?>">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="skills" placeholder="Nhập tên kỹ năng mềm hoặc cứng, (phân cách bởi dấu phẩy)" value="<?php echo $profileInformation['skills'] ?>">
                                </div>
                            </div>
                        <?php endif; ?>
                    </div>
                ...
                <div class="sticky-bottom text-center text-md-center text-sm-center text-lg-end ms-lg-auto mt-3 p-3" style="background-color: var(--section-color);">
                    <button type="submit" href="<?php echo _WEB_ROOT; ?>/quan-ly-tai-khoan/tai-khoan" style="background-color: var(--primary-color);" class="btn border border-1 px-5 py-2 rounded-3 text-white fw-semibold">Lưu và đăng hồ sơ</button>
                </div>
            </form>
        <?php endif; ?>
    </div>
