<ul class="pagination pagination-sm">
    ...
    <?php } ?>
    <li class="page-item"><a class="page-link <?php echo $page == 1 ? 'active' : ''; ?>"
            href="<?php echo $self::getPaginateLink(1, $isQuery); ?>">1</a>
    </li>
    <?php
    if ($begin > 2) {
    ?>
    ...
    ?>
    <li class="page-item"><a class="page-link <?php echo $page == $totalPage ? 'active' : ''; ?>"
            href="<?php echo $self::getPaginateLink($totalPage, $isQuery); ?>"><?php echo $totalPage; ?></a>
    </li>
